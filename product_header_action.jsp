...
try {
    ...
    PreparedStatement ps1 = con.prepareStatement("INSERT INTO product_best (product_name, product_price, product_size, product_attribute, product_mark, product_photo,category_name) VALUES (?, ?, ?, ?, ?, ?,?)");
    ps1.setString(1, product_name);
    ps1.setString(2, product_price);
    ps1.setString(3, product_size);
    ps1.setString(4, product_attribute);
    ps1.setString(5, product_mark);
    ps1.setString(6, product_photo);
    ps1.setString(7, category_name);
    ps1.executeUpdate();
