...
PreparedStatement ps3 = con.prepareStatement("SELECT * FROM product INNER JOIN cart ON product.product_ID=cart.product_ID  ON cart.product_ID=product.product_ID WHERE cart.cart_ID=? AND product.product_ID=? ");
