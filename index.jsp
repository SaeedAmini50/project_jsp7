...
<h1><li class="active"><a  name="NEW"data-toggle="tab" href="#tab2">محصولات جدید</a></li></h1>
          ...
          while (rss.next()) {
              ...
              <div class="col-md-4 col-xs-6">
                  <div class="shop">
                      <div class="shop-img">
                          <img src="./img/<%= rss.getString(6) %>" alt="">
                      </div>
                      <div class="shop-body">
                          <h3><%= rss.getString(1) %><br> AF<%= rss.getString(2) %></h3>
...
<!-- /SECTION -->
    <button class="primary-btn" onclick="showMessage('این یک پیام است.')">نمایش پیام</button>
